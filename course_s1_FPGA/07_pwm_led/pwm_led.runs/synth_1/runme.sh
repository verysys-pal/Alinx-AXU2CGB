...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/07_pwm_led/pwm_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_test.tcl
