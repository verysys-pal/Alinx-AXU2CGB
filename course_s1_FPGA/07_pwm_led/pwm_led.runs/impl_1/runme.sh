...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/07_pwm_led/pwm_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_test.tcl -notrace
