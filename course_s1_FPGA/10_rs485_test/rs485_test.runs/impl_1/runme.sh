...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/10_rs485_test/rs485_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rs485_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rs485_top.tcl -notrace
