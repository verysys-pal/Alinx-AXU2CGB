...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/10_rs485_test/rs485_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs485_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs485_top.tcl
