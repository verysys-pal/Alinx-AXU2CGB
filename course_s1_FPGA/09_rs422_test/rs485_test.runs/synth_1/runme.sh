...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/09_rs422_test/rs485_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs422_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs422_top.tcl
