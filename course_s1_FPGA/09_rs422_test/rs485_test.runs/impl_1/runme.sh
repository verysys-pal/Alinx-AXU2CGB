...
HD_PWD='E:/XilinxPrj/AXU2CG/course_32b/course_s1_fpga/09_rs422_test/rs485_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rs422_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rs422_top.tcl -notrace
