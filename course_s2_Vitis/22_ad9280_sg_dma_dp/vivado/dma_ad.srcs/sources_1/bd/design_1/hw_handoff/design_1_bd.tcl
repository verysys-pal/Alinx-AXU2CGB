...
proc create_root_design { parentCell } {
  ...
  set adc_data [ create_bd_port -dir I -from 7 -to 0 -type data adc_data ]
  ...
  # Create instance: dac_32M_reset, and set properties
  set dac_32M_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 dac_32M_reset ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {31.817863} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {33} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__FREQMHZ {32} \
  ...
  connect_bd_intf_net -intf_net ad9280_sample_0_M00_AXIS [get_bd_intf_pins ad9280_sample_0/M00_AXIS] [get_bd_intf_pins axis_register_slice_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ad9280_sample_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net dac_32M_reset_peripheral_aresetn [get_bd_pins ad9280_sample_0/adc_rst_n] [get_bd_pins dac_32M_reset/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_149M_peripheral_aresetn [get_bd_pins ad9280_sample_0/m00_axis_aresetn] [get_bd_pins ad9280_sample_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_149M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ad9280_sample_0/m00_axis_aclk] [get_bd_pins ad9280_sample_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_149M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports adc_clk] [get_bd_pins ad9280_sample_0/adc_clk] [get_bd_pins dac_32M_reset/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins dac_32M_reset/ext_reset_in] [get_bd_pins rst_ps8_0_149M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ad9280_sample_0/S00_AXI/S00_AXI_reg] -force
