...
HD_PWD='E:/XilinxPrj/AXU2CG/course_64b/course_s2/26_an5642_lwip_double/vivado/an5642_lwip.runs/design_1_cmos_rst_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cmos_rst_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cmos_rst_0.tcl
