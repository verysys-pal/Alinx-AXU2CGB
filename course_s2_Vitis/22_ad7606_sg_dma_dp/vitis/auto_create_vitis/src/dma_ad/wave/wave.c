...
{
	PointBufferPtr[(hor_x + ver_y*width)*BYTES_PIXEL + 0] = wRed;
	PointBufferPtr[(hor_x + ver_y*width)*BYTES_PIXEL + 1] = wGreen;
	PointBufferPtr[(hor_x + ver_y*width)*BYTES_PIXEL + 2] = wBlue;
	PointBufferPtr[(hor_x + ver_y*width)*BYTES_PIXEL + 3] = 0xFF;
