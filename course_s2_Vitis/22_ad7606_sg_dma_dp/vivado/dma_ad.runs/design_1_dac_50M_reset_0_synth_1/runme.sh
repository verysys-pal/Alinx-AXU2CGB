...
HD_PWD='E:/XilinxPrj/AXU2CG/course_64b/course_s2/22_ad7606_sg_dma_dp/vivado/dma_ad.runs/design_1_dac_50M_reset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dac_50M_reset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dac_50M_reset_0.tcl
