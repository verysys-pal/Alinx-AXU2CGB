...
HD_PWD='E:/XilinxPrj/AXU2CG/course_64b/course_s2/28_audio_i2s_stream/vivado/audio_test.runs/design_1_axi_i2s_adi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_i2s_adi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_i2s_adi_0_0.tcl
