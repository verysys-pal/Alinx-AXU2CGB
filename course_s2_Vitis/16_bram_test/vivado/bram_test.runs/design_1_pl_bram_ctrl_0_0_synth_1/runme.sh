...
HD_PWD='E:/XilinxPrj/AXU2CG/course_64b/course_s2/16_bram_test/vivado/bram_test.runs/design_1_pl_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pl_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pl_bram_ctrl_0_0.tcl
