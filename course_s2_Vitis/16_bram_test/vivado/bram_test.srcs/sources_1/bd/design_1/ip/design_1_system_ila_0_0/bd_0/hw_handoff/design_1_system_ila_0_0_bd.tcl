...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_BRAM_addr_1 [get_bd_ports SLOT_0_BRAM_addr] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net SLOT_0_BRAM_din_1 [get_bd_ports SLOT_0_BRAM_din] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_BRAM_dout_1 [get_bd_ports SLOT_0_BRAM_dout] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net SLOT_0_BRAM_en_1 [get_bd_ports SLOT_0_BRAM_en] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_BRAM_rst_1 [get_bd_ports SLOT_0_BRAM_rst] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_BRAM_we_1 [get_bd_ports SLOT_0_BRAM_we] [get_bd_pins ila_lib/probe5]
