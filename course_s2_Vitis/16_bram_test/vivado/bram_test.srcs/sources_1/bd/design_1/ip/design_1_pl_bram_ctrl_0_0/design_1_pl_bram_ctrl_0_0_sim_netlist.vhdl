...
-- Date        : Fri Nov 13 10:00:37 2020
-- Host        : DESKTOP-0FF260C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/XilinxPrj/AXU2CG/course_64b/course_s2/16_bram_test/vivado/bram_test.srcs/sources_1/bd/design_1/ip/design_1_pl_bram_ctrl_0_0/design_1_pl_bram_ctrl_0_0_sim_netlist.vhdl
-- Design      : design_1_pl_bram_ctrl_0_0
...
entity design_1_pl_bram_ctrl_0_0_ram_read_write is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_pl_bram_ctrl_0_0_ram_read_write : entity is "ram_read_write";
end design_1_pl_bram_ctrl_0_0_ram_read_write;

architecture STRUCTURE of design_1_pl_bram_ctrl_0_0_ram_read_write is
  ...
  signal \state1_inferred__0/i__carry__2_n_4\ : STD_LOGIC;
  signal \state1_inferred__0/i__carry__2_n_5\ : STD_LOGIC;
  signal \state1_inferred__0/i__carry__2_n_6\ : STD_LOGIC;
  signal \state1_inferred__0/i__carry__2_n_7\ : STD_LOGIC;
  ...
  signal \NLW_addr0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  signal \NLW_addr0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \NLW_dout0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  signal \NLW_dout0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  signal \NLW_state1_inferred__0/i__carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  attribute SOFT_HLUTNM of \__11/i_\ : label is "soft_lutpair0";
...
\addr0_carry__2\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 6) => \NLW_addr0_carry__2_CO_UNCONNECTED\(7 downto 6),
      ...
      DI(7 downto 0) => B"00000000",
      O(7) => \NLW_addr0_carry__2_O_UNCONNECTED\(7),
...
dout0_carry: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => dout0(8 downto 1),
      S(7 downto 0) => \^wdata\(8 downto 1)
    );
\dout0_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => dout0(16 downto 9),
      S(7 downto 0) => \^wdata\(16 downto 9)
    );
\dout0_carry__1\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => dout0(24 downto 17),
      S(7 downto 0) => \^wdata\(24 downto 17)
    );
\dout0_carry__2\: unisim.vcomponents.CARRY8
     port map (
      CI => \dout0_carry__1_n_0\,
      CI_TOP => '0',
      CO(7 downto 6) => \NLW_dout0_carry__2_CO_UNCONNECTED\(7 downto 6),
      ...
      DI(7 downto 0) => B"00000000",
      O(7) => \NLW_dout0_carry__2_O_UNCONNECTED\(7),
      O(6 downto 0) => dout0(31 downto 25),
      S(7) => '0',
      S(6 downto 0) => \^wdata\(31 downto 25)
    );
...
state1_carry: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 1) => len_tmp(8 downto 2),
      DI(0) => '0',
...
\state1_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 0) => len_tmp(16 downto 9),
...
\state1_carry__1\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7) => \state1_carry__1_n_0\,
      CO(6) => \state1_carry__1_n_1\,
      CO(5) => \state1_carry__1_n_2\,
      CO(4) => \state1_carry__1_n_3\,
      CO(3) => \state1_carry__1_n_4\,
      CO(2) => \state1_carry__1_n_5\,
      CO(1) => \state1_carry__1_n_6\,
      CO(0) => \state1_carry__1_n_7\,
      DI(7 downto 0) => len_tmp(24 downto 17),
      O(7 downto 0) => state1(24 downto 17),
      S(7) => \state1_carry__1_i_1_n_0\,
      S(6) => \state1_carry__1_i_2_n_0\,
      S(5) => \state1_carry__1_i_3_n_0\,
      S(4) => \state1_carry__1_i_4_n_0\,
...
\state1_carry__2\: unisim.vcomponents.CARRY8
     port map (
      ...
      CO(5) => \state1_carry__2_n_2\,
      CO(4) => \state1_carry__2_n_3\,
      CO(3) => \state1_carry__2_n_4\,
      CO(2) => \state1_carry__2_n_5\,
      CO(1) => \state1_carry__2_n_6\,
      CO(0) => \state1_carry__2_n_7\,
      DI(7 downto 6) => B"00",
      DI(5 downto 0) => len_tmp(30 downto 25),
      O(7) => \NLW_state1_carry__2_O_UNCONNECTED\(7),
      O(6 downto 0) => state1(31 downto 25),
      S(7) => '0',
      S(6) => \state1_carry__2_i_1_n_0\,
      S(5) => \state1_carry__2_i_2_n_0\,
      S(4) => \state1_carry__2_i_3_n_0\,
      S(3) => \state1_carry__2_i_4_n_0\,
      S(2) => \state1_carry__2_i_5_n_0\,
      S(1) => \state1_carry__2_i_6_n_0\,
      S(0) => \state1_carry__2_i_7_n_0\
    );
...
\state1_inferred__0/i__carry\: unisim.vcomponents.CARRY8
     port map (
      ...
      O(7 downto 0) => state10_in(7 downto 0),
...
\state1_inferred__0/i__carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      O(7 downto 0) => state10_in(15 downto 8),
...
\state1_inferred__0/i__carry__1\: unisim.vcomponents.CARRY8
     port map (
      CI => \state1_inferred__0/i__carry__0_n_0\,
      CI_TOP => '0',
      CO(7) => \state1_inferred__0/i__carry__1_n_0\,
      CO(6) => \state1_inferred__0/i__carry__1_n_1\,
      CO(5) => \state1_inferred__0/i__carry__1_n_2\,
      CO(4) => \state1_inferred__0/i__carry__1_n_3\,
      CO(3) => \state1_inferred__0/i__carry__1_n_4\,
      CO(2) => \state1_inferred__0/i__carry__1_n_5\,
      CO(1) => \state1_inferred__0/i__carry__1_n_6\,
      CO(0) => \state1_inferred__0/i__carry__1_n_7\,
      DI(7 downto 0) => \^q\(23 downto 16),
      O(7 downto 0) => state10_in(23 downto 16),
...
\state1_inferred__0/i__carry__2\: unisim.vcomponents.CARRY8
     port map (
      CI => \state1_inferred__0/i__carry__1_n_0\,
      CI_TOP => '0',
      CO(7) => \NLW_state1_inferred__0/i__carry__2_CO_UNCONNECTED\(7),
      CO(6) => \state1_inferred__0/i__carry__2_n_1\,
      CO(5) => \state1_inferred__0/i__carry__2_n_2\,
      CO(4) => \state1_inferred__0/i__carry__2_n_3\,
      CO(3) => \state1_inferred__0/i__carry__2_n_4\,
      CO(2) => \state1_inferred__0/i__carry__2_n_5\,
      CO(1) => \state1_inferred__0/i__carry__2_n_6\,
      CO(0) => \state1_inferred__0/i__carry__2_n_7\,
      DI(7) => '0',
      DI(6 downto 0) => \^q\(30 downto 24),
      O(7 downto 0) => state10_in(31 downto 24),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0_S00_AXI : entity is "pl_bram_ctrl_v1_0_S00_AXI";
end design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0_S00_AXI;

architecture STRUCTURE of design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0_S00_AXI is
...
ram_inst: entity work.design_1_pl_bram_ctrl_0_0_ram_read_write
     port map (
      ...
      s00_axi_aresetn_0 => ram_inst_n_65,
      s00_axi_wdata(0) => s00_axi_wdata(0),
      slv_reg0(1 downto 0) => slv_reg0(1 downto 0),
      \slv_reg0_reg[0]\ => ram_inst_n_68,
      \slv_reg0_reg[0]_0\ => \slv_reg0[7]_i_1_n_0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0 is
  port (
    addr : out STD_LOGIC_VECTOR ( 31 downto 0 );
    wdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    S_AXI_WREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0 : entity is "pl_bram_ctrl_v1_0";
end design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0;

architecture STRUCTURE of design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0 is
begin
pl_bram_ctrl_v1_0_S00_AXI_inst: entity work.design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pl_bram_ctrl_0_0 is
  port (
  ...
  attribute NotValidForBitStream of design_1_pl_bram_ctrl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_pl_bram_ctrl_0_0 : entity is "design_1_pl_bram_ctrl_0_0,pl_bram_ctrl_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_pl_bram_ctrl_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_pl_bram_ctrl_0_0 : entity is "pl_bram_ctrl_v1_0,Vivado 2020.1";
end design_1_pl_bram_ctrl_0_0;

architecture STRUCTURE of design_1_pl_bram_ctrl_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \^s00_axi_aclk\ : STD_LOGIC;
  signal \^we\ : STD_LOGIC_VECTOR ( 2 to 2 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:interface:bram:1.0 BRAM_PORT CLK";
  ...
  attribute X_INTERFACE_INFO of rst : signal is "xilinx.com:interface:bram:1.0 BRAM_PORT RST";
...
inst: entity work.design_1_pl_bram_ctrl_0_0_pl_bram_ctrl_v1_0
     port map (
