...
module design_1
  ...
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None ADDR" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire [31:0]pl_bram_ctrl_0_BRAM_PORT_ADDR;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None CLK" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire pl_bram_ctrl_0_BRAM_PORT_CLK;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None DIN" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire [31:0]pl_bram_ctrl_0_BRAM_PORT_DIN;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None DOUT" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire [31:0]pl_bram_ctrl_0_BRAM_PORT_DOUT;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None EN" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire pl_bram_ctrl_0_BRAM_PORT_EN;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None RST" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire pl_bram_ctrl_0_BRAM_PORT_RST;
  (* CONN_BUS_INFO = "pl_bram_ctrl_0_BRAM_PORT xilinx.com:interface:bram:1.0 None WE" *) (* DEBUG = "true" *) (* MARK_DEBUG *) wire [3:0]pl_bram_ctrl_0_BRAM_PORT_WE;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire pl_bram_ctrl_0_intr;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(pl_bram_ctrl_0_BRAM_PORT_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(pl_bram_ctrl_0_BRAM_PORT_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(pl_bram_ctrl_0_BRAM_PORT_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(pl_bram_ctrl_0_BRAM_PORT_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(pl_bram_ctrl_0_BRAM_PORT_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(pl_bram_ctrl_0_BRAM_PORT_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(pl_bram_ctrl_0_BRAM_PORT_WE));
  design_1_pl_bram_ctrl_0_0 pl_bram_ctrl_0
       (.addr(pl_bram_ctrl_0_BRAM_PORT_ADDR),
        .clk(pl_bram_ctrl_0_BRAM_PORT_CLK),
        .en(pl_bram_ctrl_0_BRAM_PORT_EN),
        .intr(pl_bram_ctrl_0_intr),
        .rdata(pl_bram_ctrl_0_BRAM_PORT_DOUT),
        .rst(pl_bram_ctrl_0_BRAM_PORT_RST),
        ...
        .wdata(pl_bram_ctrl_0_BRAM_PORT_DIN),
        .we(pl_bram_ctrl_0_BRAM_PORT_WE));
  ...
  design_1_system_ila_0_0 system_ila_0
       (.SLOT_0_BRAM_addr(pl_bram_ctrl_0_BRAM_PORT_ADDR),
        .SLOT_0_BRAM_clk(pl_bram_ctrl_0_BRAM_PORT_CLK),
        .SLOT_0_BRAM_din(pl_bram_ctrl_0_BRAM_PORT_DIN),
        .SLOT_0_BRAM_dout(pl_bram_ctrl_0_BRAM_PORT_DOUT),
        .SLOT_0_BRAM_en(pl_bram_ctrl_0_BRAM_PORT_EN),
        .SLOT_0_BRAM_rst(pl_bram_ctrl_0_BRAM_PORT_RST),
        .SLOT_0_BRAM_we(pl_bram_ctrl_0_BRAM_PORT_WE),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe0(pl_bram_ctrl_0_intr));
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp2_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARADDR),
        ...
        .pl_ps_irq0(pl_bram_ctrl_0_intr),
