...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net pl_bram_ctrl_0_BRAM_PORT [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins pl_bram_ctrl_0/BRAM_PORT]
connect_bd_intf_net -intf_net [get_bd_intf_nets pl_bram_ctrl_0_BRAM_PORT] [get_bd_intf_pins pl_bram_ctrl_0/BRAM_PORT] [get_bd_intf_pins system_ila_0/SLOT_0_BRAM]
  ...
  connect_bd_net -net pl_bram_ctrl_0_intr [get_bd_pins pl_bram_ctrl_0/intr] [get_bd_pins system_ila_0/probe0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets pl_bram_ctrl_0_intr]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins pl_bram_ctrl_0/s00_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins pl_bram_ctrl_0/s00_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pl_bram_ctrl_0/S00_AXI/S00_AXI_reg] -force
