...
HD_PWD='E:/XilinxPrj/AXU2CG/course_64b/27_an5641_mipi_dp/vivado/mipi_dp.runs/design_1_v_demosaic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_demosaic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_demosaic_0_0.tcl
