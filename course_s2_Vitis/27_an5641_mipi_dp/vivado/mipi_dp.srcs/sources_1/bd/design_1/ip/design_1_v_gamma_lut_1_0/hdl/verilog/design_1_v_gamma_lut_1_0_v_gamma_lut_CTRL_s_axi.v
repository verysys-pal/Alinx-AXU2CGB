...
// ==============================================================
`timescale 1ns/1ps
module design_1_v_gamma_lut_1_0_v_gamma_lut_CTRL_s_axi
#(parameter
...
design_1_v_gamma_lut_1_0_v_gamma_lut_CTRL_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 512 )
) int_HwReg_gamma_lut_0 (
    .clk0     ( ACLK ),
...
module design_1_v_gamma_lut_1_0_v_gamma_lut_CTRL_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
