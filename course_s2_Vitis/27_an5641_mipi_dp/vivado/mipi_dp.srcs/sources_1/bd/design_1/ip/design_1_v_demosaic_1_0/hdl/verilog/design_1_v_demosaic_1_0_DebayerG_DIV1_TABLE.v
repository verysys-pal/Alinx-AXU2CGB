...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE_rom (
...
initial begin
    $readmemh("./design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE_rom.dat", ram0);
    $readmemh("./design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE_rom.dat", ram1);
end
...
`timescale 1 ns / 1 ps
module design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE(
    reset,
    clk,
    address0,
    ce0,
...
design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE_rom design_1_v_demosaic_1_0_DebayerG_DIV1_TABLE_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
