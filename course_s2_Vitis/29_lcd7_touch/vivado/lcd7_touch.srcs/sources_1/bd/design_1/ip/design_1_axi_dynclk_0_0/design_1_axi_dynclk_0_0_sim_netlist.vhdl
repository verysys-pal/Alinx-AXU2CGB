...
-- Date        : Fri Nov 13 13:21:23 2020
-- Host        : DESKTOP-0FF260C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/XilinxPrj/AXU2CG/course_64b/course_s2/29_lcd7_touch/vivado/lcd7_touch.srcs/sources_1/bd/design_1/ip/design_1_axi_dynclk_0_0/design_1_axi_dynclk_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_axi_dynclk_0_0_mmcme2_drp is
  ...
  signal NLW_mmcm_adv_inst_CLKFBIN_UNCONNECTED : STD_LOGIC;
  signal NLW_mmcm_adv_inst_CLKFBOUT_UNCONNECTED : STD_LOGIC;
...
architecture STRUCTURE of design_1_axi_dynclk_0_0_axi_dynclk is
  ...
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of BUFIO_inst : label is "BUFIO";
  attribute LOPT_BUFG_MISC : boolean;
  attribute LOPT_BUFG_MISC of BUFR_inst : label is std.standard.true;
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of BUFR_inst : label is "MLO";
  attribute XILINX_LEGACY_PRIM of BUFR_inst : label is "BUFR";
  attribute FSM_ENCODED_STATES : string;
...
begin
  LOCKED_O <= \^locked_o\;
BUFIO_inst: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
    )
        port map (
...
BUFR_inst: unisim.vcomponents.BUFGCE_DIV
    generic map(
      BUFGCE_DIVIDE => 5
    )
        port map (
...
entity design_1_axi_dynclk_0_0 is
  ...
  attribute x_core_info of design_1_axi_dynclk_0_0 : entity is "axi_dynclk,Vivado 2020.1";
...
architecture STRUCTURE of design_1_axi_dynclk_0_0 is
  ...
  attribute x_interface_parameter of REF_CLK_I : signal is "XIL_INTERFACENAME REF_CLK_I, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
  attribute x_interface_info of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 s00_axi_signal_clock CLK";
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME s00_axi_signal_clock, ASSOCIATED_BUSIF s00_axi, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
