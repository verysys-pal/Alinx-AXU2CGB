...
// ==============================================================
`timescale 1ns/1ps
module design_1_v_frmbuf_wr_0_0_v_frmbuf_wr_CTRL_s_axi
#(parameter
    ...
    output wire [31:0]                   HwReg_frm_buffer_V,
    output wire [31:0]                   HwReg_frm_buffer2_V,
...
localparam
    ...
    ADDR_HWREG_FRM_BUFFER_V_CTRL    = 7'h34,
    ADDR_HWREG_FRM_BUFFER2_V_DATA_0 = 7'h3c,
    ADDR_HWREG_FRM_BUFFER2_V_CTRL   = 7'h40,
    WRIDLE                          = 2'd0,
    WRDATA                          = 2'd1,
    WRRESP                          = 2'd2,
    WRRESET                         = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_HwReg_frm_buffer_V = 'b0;
    reg  [31:0]                   int_HwReg_frm_buffer2_V = 'b0;
