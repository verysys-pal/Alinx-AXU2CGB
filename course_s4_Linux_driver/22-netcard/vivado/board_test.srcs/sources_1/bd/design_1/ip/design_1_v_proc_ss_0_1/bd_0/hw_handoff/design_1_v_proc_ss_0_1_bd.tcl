...
################################################################
# This is a generated script based on design: bd_19ea
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.USE_URAM {0} \
   CONFIG.V_CSC_MAX_HEIGHT {1080} \
   CONFIG.V_CSC_MAX_WIDTH {1920} \
 ] $csc
