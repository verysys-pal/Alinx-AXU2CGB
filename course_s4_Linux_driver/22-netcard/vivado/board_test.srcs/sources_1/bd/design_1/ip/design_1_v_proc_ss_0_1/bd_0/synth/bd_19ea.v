...
//--------------------------------------------------------------------------------
//Command: generate_target bd_19ea.bd
//Design : bd_19ea
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_19ea,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_19ea,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1_v_proc_ss_0_1.hwdef" *) 
module bd_19ea
   (aclk,
    aresetn,
    m_axis_tdata,
  ...
  wire [8:0]intf_net_bdry_in_s_axi_ctrl_ARADDR;
  wire intf_net_bdry_in_s_axi_ctrl_ARREADY;
  wire intf_net_bdry_in_s_axi_ctrl_ARVALID;
  wire [8:0]intf_net_bdry_in_s_axi_ctrl_AWADDR;
  ...
  assign intf_net_bdry_in_s_axi_ctrl_ARADDR = s_axi_ctrl_araddr[8:0];
  assign intf_net_bdry_in_s_axi_ctrl_ARVALID = s_axi_ctrl_arvalid;
  assign intf_net_bdry_in_s_axi_ctrl_AWADDR = s_axi_ctrl_awaddr[8:0];
