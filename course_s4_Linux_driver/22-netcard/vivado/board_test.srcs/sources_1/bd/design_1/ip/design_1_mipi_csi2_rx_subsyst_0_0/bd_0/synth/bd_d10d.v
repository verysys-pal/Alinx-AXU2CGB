...
(* CORE_GENERATION_INFO = "bd_d10d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_d10d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_d10d
   (clkoutphy_out,
    csirxss_csi_irq,
  ...
  assign video_out_tdata[31:0] = vfb_0_m_vfb_TDATA;
